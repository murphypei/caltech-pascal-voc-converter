...
"""
input caltech format dataset path, convert vbb annoations to json annotations
"""
...
def convert_annotations(path):
    ...
    for dname in sorted(glob.glob(os.path.join(path, 'annotations/set*'))):
    ...
    json.dump(data, open(os.path.join(path, 'annotations.json'), 'w'))
